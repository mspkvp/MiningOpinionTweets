...
var entity_response = null;
var topics_response = null;
var REQUESTS_URL = "http://localhost:5000"

$.ajax({
    type: 'GET',
    url: REQUESTS_URL + '/cristiano_ronaldo',
    dataType: 'json',
    success: function(data) { entity_response = data },
    data: {},
    async: false
});
...
$.ajax({
    type: 'GET',
    url: REQUESTS_URL + '/cristiano_ronaldo/2014-06-03/topics',
    dataType: 'json',
    success: function(data) { topics_response = data },
    data: {},
    async: false
});
...
// All the topics
data.topics = topics_response.topics;
...
// All the comments
data.comments = entity_response.tweets;
...
// Trends
data.trends = entity_response.trends;
...
function updateLabels() {
  ...
  label
    ...
    .select(".g-value")
      .text(function(d) { return (d.count - 1) + (d.r > 60 ? " menções" : ""); });
